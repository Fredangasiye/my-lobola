...
export default function AppLayout() {
  ...
  // THIS IS THE FIX: While Clerk is figuring out who the user is,
  // we show a simple "Loading..." message. This prevents any crashes.
  if (!isLoaded) {
  ...
  return (
    <div className="min-h-screen bg-cream">
      <header className="bg-primary-green text-white py-6 px-4 shadow-lg">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {/* We can still use SignedIn/Out for simple buttons like this */}
            {isSignedIn ? (
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        {/* 
          Now we use a simple, crash-proof check to decide which page to show.
        */}
