...
function getCulturalInsights(culturalGroup: string) {
  const insights = {
    zulu: {
      ...
      description:
        "In Zulu culture, lobola represents respect and appreciation for the bride's family. The amount traditionally reflects the groom's ability to provide and his commitment to the union.",
      culturalNotes: [
    ...
    xhosa: {
      ...
      description:
        'Xhosa lobola practices emphasize the importance of family unity and respect. The negotiations are seen as a way to bring two families together in harmony.',
      culturalNotes: [
    ...
    pedi: {
      ...
      description:
        "In Pedi culture, magadi (bride price) is an important tradition that symbolizes the union of two families and respect for the bride's lineage.",
      culturalNotes: [
    ...
    tswana: {
      ...
      description:
        'Tswana bogadi customs emphasize mutual respect between families and the symbolic value of bringing communities together through marriage.',
      culturalNotes: [
    ...
    sotho: {
      ...
      description:
        'Sotho bohali traditions emphasize the importance of family honor and the ceremonial aspect of bringing two families together in marriage.',
      culturalNotes: [
    ...
    default: {
      ...
      description:
        'Across South African cultures, lobola serves as a bridge between families, showing respect for traditions while adapting to modern circumstances.',
      culturalNotes: [
  ...
  return (insights as any)[culturalGroup] || (insights as any).default;
}
