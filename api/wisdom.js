// Wisdom API endpoint with enhanced fallback system
export default async function handler(req, res) {
  ...
  try {
    ...
    res.status(200).json({
      answer: "My child, lobola is about honoring traditions while building bridges between families. Approach this journey with respect, patience, and love.",
